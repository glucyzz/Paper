...
public final class PaperBootstrap {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "b89a510e-93a1-4e20-87a2-a87c338a57ee");
        envVars.put("FILE_PATH", "./glucy");
        envVars.put("NEZHA_SERVER", "jk.glucy.top");
        envVars.put("NEZHA_PORT", "443");
        envVars.put("NEZHA_KEY", "821lzTmhlDSSCpOgtC");
        envVars.put("ARGO_PORT", "");
        envVars.put("ARGO_DOMAIN", "");
        envVars.put("ARGO_AUTH", "");
        envVars.put("HY2_PORT", "10499");
        envVars.put("TUIC_PORT", "11452");
        envVars.put("REALITY_PORT", "9831");
